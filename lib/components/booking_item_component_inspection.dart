...
class BookingItemComponentInspection extends StatefulWidget {
  ...
  const BookingItemComponentInspection({super.key, 
    this.status,
  ...
  @override
  BookingItemComponentInspectionState createState() =>
      BookingItemComponentInspectionState();
}

class BookingItemComponentInspectionState
    extends State<BookingItemComponentInspection> {
  @override
  void initState() {
    super.initState();
    init();
  ...
  Future<void> confirmationRequestDialog(
    ...
    showConfirmDialogCustom(
      ...
      onAccept: (context) async {
        await updateBooking(widget.bookingData, status, index).then((v) {
          setState(() {});
        });
      },
    );
          ...
          Row(
            ...
            children: [
              if (widget.bookingData.isPackageBooking &&
                ...
                CachedImageWidget(
                  url:
                      widget.bookingData.imageAttachments.validate().isNotEmpty
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            8.width,
                            Text(
                              widget.bookingData.description.validate(),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: boldTextStyle(size: 12),
                              textAlign: TextAlign.right,
                            ...
                            onTap: () async {
                              await showConfirmDialogCustom(
                                ...
                                onAccept: (_) async {
                                  ...
                                  var req = await bookingUpdate(request)
                                      .then((res) async {
                                        appStore.setLoading(false);
                                        LiveStream().emit(
