...
import 'package:trade/handyman/screen/inspection_screen.dart';
...
import 'package:trade/screens/booking_details/booking_detail_screen.dart';
import 'package:trade/utils/common.dart';
import 'package:trade/utils/configs.dart';
import 'package:trade/utils/constant.dart';
import 'package:trade/utils/extensions/color_extension.dart';
...
class BookingItemComponentState extends State<BookingItemComponent> {
  ...
  Future<void> saveInspectionToStart(int inspectionId, int customerId) async {
    appStore.setLoading(true);
    Map req = {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              left: 8, right: 8, top: 8, bottom: widget.inspection ? 0 : 8),
                      ...
                      Row(
                        children: [
                          ...
                          AppButton(
                            ...
                            onTap: () {
                              if (isUserTypeProvider) {
                                confirmationRequestDialog(context,
                                    widget.index!, BookingStatusKeys.rejected);
                              } else {
                                confirmationRequestDialog(context,
                                    widget.index!, BookingStatusKeys.pending);
                              }
                            },
                            child:
                      ...
                      children: [
                        ...
                        Expanded(
                          child: AppButton(
                            ...
                            onTap: () {
                              Navigator.pop(context);
                              saveInspectionToStart(widget.bookingData.id ?? 0,
                                  widget.bookingData.customerId ?? 0);
                              InspectionScreen(
                                bookingId: widget.bookingData.id ?? 0,
                                lastInspectedDate: widget.bookingData.date,
                                projectManager: widget.bookingData.providerName,
                                searchedOwner:
