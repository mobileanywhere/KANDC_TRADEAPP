...
import 'package:trade/provider/fragments/shimmer/provider_payment_shimmer.dart';
...
class ProviderPaymentFragment extends StatefulWidget {
  const ProviderPaymentFragment({super.key});
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('#${data.bookingId.validate()}', style: boldTextStyle(color: primaryColor, size: 12)),
                            ],
                          ),
                        ),
                        4.height,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text("#${data.id.validate()}", style: boldTextStyle(size: 12)),
                              ],
