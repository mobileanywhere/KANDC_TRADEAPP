...
import 'package:trade/auth/change_password_screen.dart';
import 'package:trade/auth/edit_profile_screen.dart';
import 'package:trade/auth/sign_in_screen.dart';
import 'package:trade/components/cached_image_widget.dart';
import 'package:trade/components/theme_selection_dailog.dart';
import 'package:trade/main.dart';
import 'package:trade/models/user_data.dart';
import 'package:trade/networks/rest_apis.dart';
import 'package:trade/provider/blog/view/blog_list_screen.dart';
import 'package:trade/provider/handyman_list_screen.dart';
import 'package:trade/provider/jobRequest/bid_list_screen.dart';
import 'package:trade/provider/packages/package_list_screen.dart';
import 'package:trade/provider/service_address/service_addresses_screen.dart';
import 'package:trade/provider/services/service_list_screen.dart';
import 'package:trade/provider/subscription/subscription_history_screen.dart';
import 'package:trade/provider/taxes/taxes_screen.dart';
import 'package:trade/provider/timeSlots/my_time_slots_screen.dart';
import 'package:trade/provider/wallet/wallet_history_screen.dart';
import 'package:trade/screens/about_us_screen.dart';
import 'package:trade/screens/languages_screen.dart';
import 'package:trade/screens/verify_provider_screen.dart';
...
class ProviderProfileFragment extends StatefulWidget {
  ...
  const ProviderProfileFragment({super.key, this.list});
