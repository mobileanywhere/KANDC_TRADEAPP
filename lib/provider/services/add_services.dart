...
import 'package:trade/provider/services/components/service_address_component.dart';
...
class AddServices extends StatefulWidget {
  ...
  const AddServices({super.key, this.data});
            ...
            Row(
              children: [
                ...
                DropdownButtonFormField<StaticDataModel>(
                  isExpanded: true,
                  dropdownColor: context.cardColor,
                  value: serviceStatusModel ?? statusListStaticData.first,
