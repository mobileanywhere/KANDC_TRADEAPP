...
import 'package:trade/provider/timeSlots/components/slot_widget.dart';
...
class AvailableSlotsComponent extends StatefulWidget {
  ...
  const AvailableSlotsComponent({this.selectedSlots, required this.availableSlots, required this.onChanged, this.isProvider = true, super.key});
