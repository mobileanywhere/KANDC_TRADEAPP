...
import 'package:trade/provider/timeSlots/components/available_slots_component.dart';
import 'package:trade/provider/timeSlots/components/days_bottom_sheet.dart';
...
class EditTimeSlotScreen extends StatefulWidget {
  ...
  const EditTimeSlotScreen({super.key, required this.slotData, this.selectedDay, required this.onSave});
