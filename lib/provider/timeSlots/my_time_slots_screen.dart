...
import 'package:trade/provider/timeSlots/components/days_component.dart';
import 'package:trade/provider/timeSlots/components/disclaimer_widget.dart';
import 'package:trade/provider/timeSlots/components/slot_component.dart';
import 'package:trade/provider/timeSlots/edit_time_slot_screen.dart';
import 'package:trade/provider/timeSlots/models/slot_data.dart';
import 'package:trade/provider/timeSlots/services/time_slot_services.dart';
...
class MyTimeSlotsScreen extends StatefulWidget {
  ...
  const MyTimeSlotsScreen({super.key, this.isFromService = false});
