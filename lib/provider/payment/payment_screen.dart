...
import 'package:trade/provider/payment/components/cinet_pay_services.dart';
import 'package:trade/provider/payment/components/razor_pay_services.dart';
import 'package:trade/provider/payment/components/sadad_services.dart';
...
class PaymentScreen extends StatefulWidget {
  ...
  const PaymentScreen(this.selectedPricingPlan, {super.key});
    ...
    if (selectedPaymentSetting!.type == PAYMENT_METHOD_STRIPE) {
      ...
      if (selectedPaymentSetting!.isTest == 1) {
        ...
        razorPayServices.init(
            razorKey: selectedPaymentSetting!.testValue!.razorKey!,
            data: widget.selectedPricingPlan);

        await 1.seconds.delay;
        appStore.setLoading(false);
        razorPayServices
            .razorPayCheckout(widget.selectedPricingPlan.amount.validate());
      } else {
        appStore.setLoading(true);
        razorPayServices.init(
            razorKey: selectedPaymentSetting!.liveValue!.razorKey!,
            data: widget.selectedPricingPlan);
      ...
      if (selectedPaymentSetting!.isTest == 1) {
        ...
        //       selectedPaymentSetting!.testValue!.flutterwavePublic.validate(),
        //   flutterWaveSecretKey:
        //       selectedPaymentSetting!.testValue!.flutterwaveSecret.validate(),
        //   isTestMode: true,
        // );
      } else {
        // appStore.setLoading(true);
        ...
        //   selectedPricingPlan: widget.selectedPricingPlan,
        //   flutterWavePublicKey:
        //       selectedPaymentSetting!.liveValue!.flutterwavePublic.validate(),
        //   flutterWaveSecretKey:
        //       selectedPaymentSetting!.liveValue!.flutterwaveSecret.validate(),
        //   isTestMode: false,
        // );
      }
      ...
      if (selectedPaymentSetting!.isTest == 1) {
        CinetPayServices cinetPayServices = CinetPayServices(
          cinetPayApiKey:
              selectedPaymentSetting!.testValue!.cinetPublicKey.validate(),
          totalAmount: widget.selectedPricingPlan.amount.validate(),
        ...
        CinetPayServices cinetPayServices = CinetPayServices(
          cinetPayApiKey:
              selectedPaymentSetting!.liveValue!.cinetPublicKey.validate(),
          totalAmount: widget.selectedPricingPlan.amount.validate(),
          planData: widget.selectedPricingPlan,
      ...
      if (selectedPaymentSetting!.isTest == 1) {
        ...
        SadadServices sadadServices = SadadServices(
          ...
          sadadDomain:
              selectedPaymentSetting!.testValue!.sadadDomain.validate(),
          totalAmount: widget.selectedPricingPlan.amount.validate(),
          planData: widget.selectedPricingPlan,
        );
        ...
        SadadServices sadadServices = SadadServices(
          ...
          sadadDomain:
              selectedPaymentSetting!.liveValue!.sadadDomain.validate(),
          totalAmount: widget.selectedPricingPlan.amount.validate(),
          planData: widget.selectedPricingPlan,
        );
