...
import 'package:trade/provider/packages/components/selected_service_component.dart';
import 'package:trade/provider/packages/select_service_screen.dart';
...
class AddPackageScreen extends StatefulWidget {
  ...
  const AddPackageScreen({super.key, this.data});
...
class _AddPackageScreenState extends State<AddPackageScreen> {
  ...
  void init() async {
    ...
    if (isUpdate) {
      ...
      selectedCategoryId = widget.data!.categoryId ?? selectedCategoryId;
      selectedSubCategoryId = widget.data!.subCategoryId ?? selectedSubCategoryId;
                ...
                Row(
                  children: [
                    ...
                    DropdownButtonFormField<StaticDataModel>(
                      ...
                      value: packageStatusModel ?? statusListStaticData.first,
  ...
  Future checkValidation() async {
    if (formKey.currentState!.validate()) {
      ...
      if (appStore.selectedServiceList.isNotEmpty) {
        for (var element in appStore.selectedServiceList) {
