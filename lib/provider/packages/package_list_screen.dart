...
import 'package:trade/provider/packages/add_package_screen.dart';
import 'package:trade/provider/packages/package_detail_screen.dart';
import 'package:trade/provider/packages/shimmer/package_list_shimmer.dart';
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        PopupMenuButton(
                          ...
                          itemBuilder: (context) => [
                            PopupMenuItem(value: 1, child: Text(languages.lblEdit, style: boldTextStyle())),
                            PopupMenuItem(value: 2, child: Text(languages.lblDelete, style: boldTextStyle())),
                          ],
                        ),
                      ],
                    ),
