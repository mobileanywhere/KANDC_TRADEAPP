...
import 'package:trade/handyman/component/handyman_review_component.dart';
import 'package:trade/handyman/component/handyman_total_component.dart';
import 'package:trade/screens/cash_management/component/today_cash_component.dart';
import 'package:trade/handyman/shimmer/handyman_dashboard_shimmer.dart';
...
class HandymanHomeFragment extends StatefulWidget {
  const HandymanHomeFragment({super.key});
                ...
                return AnimatedScrollView(
                  ...
                  children: [
                    ...
                    TodayCashComponent(
                      todayCashAmount:
                          isUserTypeHandyman
                              ? snap.data!.todayBooking.validate()
                              : 0,
                    ),
                    8.height,
