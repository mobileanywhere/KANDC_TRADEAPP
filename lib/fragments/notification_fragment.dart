...
import 'package:trade/components/notification_widget.dart';
    ...
    return AnimatedListView(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () async {
            if (data.data!.type != ADD_WALLET &&
                data.data!.type != UPDATE_WALLET &&
                data.data!.type != WALLET_PAYOUT_TRANSFER &&
                data.data!.type == PAYOUT) {
